	    ...
	    value: function _createTemplates() {
	      ...
	      var templates = {
	        ...
	        item: function item(data) {
	          var list_countries=["Afghanistan", "Albania", "Algeria", "American Samoa", "Andorra",
                               ...
                               "Puerto Rico", "Qatar", "Romania", "Rwanda", "Samoa", "San Marino",
                               ...
                               "Western Sahara", "Virgin Islands (U.S.)", "Yemen", "Zambia",
                               "Zimbabwe", "South Sudan", "Curaçao", "Sint Maarten (Dutch part)",
                               "Antarctica", "Kyrgyzstan", "Saint Kitts and Nevis", "Saint Lucia",
                               "Saint Vincent and the Grenadines", "Cook Islands",
                               "Falkland Islands (Malvinas)", "Saint Barthélemy"];
              var id_selected = "none";
              if(list_countries.indexOf(data.value) > -1){
                id_selected = "country"+data.id % 10;
              }
	          if (_this22.config.removeItemButton) {
	            return (0, _utils.strToEl)('\n            <div class="' + classNames.item + ' ' + (data.highlighted ? classNames.highlightedState : '') + ' ' + (!data.disabled ? classNames.itemSelectable : '') + '" data-item data-id="' + data.id + '" data-value="' + data.value + '" ' + (data.active ? 'aria-selected="true"' : '') + ' ' + (data.disabled ? 'aria-disabled="true"' : '') + ' data-deletable id=' + id_selected + '>\n            ' + data.label + '<button type="button" class="' + classNames.button + '" data-button>Remove item</button>\n            </div>\n          ');
	          }
